...
int plotErr (int n, double[n+1], double[n+1][n+1], double[n+1], double[n+1][n+1], double[2]);
...
int plotErr (int n, double ne[n+1], double me[n+1][n+1], double nc[n+1], double mc[n+1][n+1], double err[2]) {
  FILE *data;
